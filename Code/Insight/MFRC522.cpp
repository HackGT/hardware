...
MFRC522::StatusCode MFRC522::MIFARE_FastRead(byte startAddr, byte endAddr, byte *buffer, byte *bufferSize) {
    MFRC522::StatusCode result;
    ...
    // Transmit the buffer and receive the response, validate CRC_A.
    return PCD_TransceiveData(buffer, 5, buffer, bufferSize, nullptr, 0, true);
}
